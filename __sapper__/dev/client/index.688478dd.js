import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, t as text, c as claim_element, a as children, b as claim_text, f as detach_dev, g as add_location, h as insert_dev, j as append_dev, k as space, l as claim_space, m as attr_dev, n as noop, o as listen_dev, p as create_component, q as query_selector_all, r as claim_component, u as mount_component, w as transition_in, x as transition_out, y as destroy_component } from './client.44ee4f5f.js';
import { B as Button } from './Button.4365d2d6.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h1, "class", "text-center svelte-1l0ahv3");
			add_location(h1, file$1, 11, 1, 208);
			attr_dev(h2, "class", "text-center svelte-1l0ahv3");
			add_location(h2, file$1, 12, 1, 279);
			attr_dev(img0, "class", "img-1 svelte-1l0ahv3");
			...
			attr_dev(div0, "class", "btn svelte-1l0ahv3");
			add_location(div0, file$1, 18, 1, 446);
			attr_dev(main, "class", "svelte-1l0ahv3");
			add_location(main, file$1, 10, 0, 200);
			attr_dev(img1, "class", "img-2 svelte-1l0ahv3");
			...
			attr_dev(p0, "class", "message text-center svelte-1l0ahv3");
			add_location(p0, file$1, 30, 2, 676);
			attr_dev(div1, "class", "section-one-content width svelte-1l0ahv3");
			add_location(div1, file$1, 24, 1, 542);
			attr_dev(section0, "class", "section-one svelte-1l0ahv3");
			...
			attr_dev(img2, "class", "svelte-1l0ahv3");
			add_location(img2, file$1, 39, 2, 921);
			attr_dev(h30, "class", "svelte-1l0ahv3");
			add_location(h30, file$1, 40, 2, 978);
			attr_dev(p1, "class", "svelte-1l0ahv3");
			add_location(p1, file$1, 41, 2, 1047);
			attr_dev(article0, "class", "card text-center svelte-1l0ahv3");
			...
			attr_dev(img3, "class", "svelte-1l0ahv3");
			add_location(img3, file$1, 47, 2, 1213);
			attr_dev(h31, "class", "svelte-1l0ahv3");
			add_location(h31, file$1, 48, 2, 1270);
			attr_dev(p2, "class", "svelte-1l0ahv3");
			add_location(p2, file$1, 49, 2, 1329);
			attr_dev(article1, "class", "card text-center svelte-1l0ahv3");
			add_location(article1, file$1, 46, 1, 1176);
			attr_dev(section1, "class", "cards-wrapper width svelte-1l0ahv3");
